...
module.exports = function (options) {
  ...
  function init (args, done) {
    ...
    seneca
      // tag actions
      .add('role: concorda, cmd: listTags', routeExternal)
      .add('role: concorda, cmd: listTagsAlias', routeExternal)
      .add('role: concorda, cmd: userAddTag', routeExternal)
      .add('role: concorda, cmd: userRemoveTag', routeExternal)
      // user actions
      .add('role: auth, c' +
        'md: create_reset', routeExternal)
    ...
    // client actions
      ...
      .add('role: concorda, cmd: publicUpdateClient', routeExternal)
