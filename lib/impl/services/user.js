...
module.exports = function (options) {
  ...
  function createUser (msg, response) {
    ...
    userData.emailValidated = _.has(userData, 'emailValidated') ? userData.emailValidated : false
  ...
  function enableUser (msg, response) {
    let userId = msg.user_id || 'N/A'
    let context = this
  ...
  function disableUser (msg, response) {
    let userId = msg.user_id || 'N/A'
    let context = this
  ...
  function init (args, done) {
    seneca
      ...
      .add('role: concorda, cmd: enableUser', enableUser)
      .add('role: concorda, cmd: disableUser', disableUser)
